...
/**
 * Weather App view toggle button with included trailing icon as well as compact and expanded
...
fun WeViewToggleButton(
    ...
    TextButton(
        ...
        contentPadding = WeViewToggleDefaults.ViewToggleButtonContentPadding,
    ) {
        WeViewToggleButtonContent(
            text = if (expanded) expandedText else compactText,
            trailingIcon = {
                Icon(
                    imageVector = if (expanded) WeIcons.ViewDay else WeIcons.ShortText,
...
/**
 * Internal Weather App view toggle button content layout for arranging the text label and
 * trailing icon.
 *
 ...
 */
@Composable
private fun WeViewToggleButtonContent(
...
/**
 * Weather App view toggle default values.
 */
object WeViewToggleDefaults {
    // TODO: File bug
